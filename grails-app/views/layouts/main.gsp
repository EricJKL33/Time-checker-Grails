    ...
    >
      <div class="container-fluid" style="display: block; text-align: center;">
        <a class="navbar-brand" href="/#"
          ><asset:image
            src="time-left-svgrepo-com.svg"
            alt="Time Logo"
            style="
              width: 80px;
              height: 80px;
              margin: 10px auto;
              filter: drop-shadow( 4px 3px 5px rgba(33, 33, 33, 0.736))
            "
        /></a>
        <button
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col">
            ...
            >
            <p>
              You working too hard? Check out the time!!
              <a href="http://guides.grails.org" target="_blank"
                >Grails Guides</a
              >
            </p>
          ...
          <div class="col">
            ...
            >
            <p>
              Missing anything? Check out the time!!
              <a href="http://docs.grails.org" target="_blank">User Guide</a>.
            </p>
          </div>
          <div class="col">
            ...
            >
            <p>
              Let's have a break and check out the time!!
              <a href="https://slack.grails.org" target="_blank"
                >Slack channel</a
              >.
            </p>
